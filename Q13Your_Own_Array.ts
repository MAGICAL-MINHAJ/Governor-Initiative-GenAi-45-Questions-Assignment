// my array about my desired transportation.
let transportation: string[] = ["Tractor", "Heavy bike", "BMW", "Tesla", "private jet"];

// Print a series of statements about these transportation modes
